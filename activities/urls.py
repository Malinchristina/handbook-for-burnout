...
urlpatterns = [
    ...
    path('indoor-activities/', views.indoor_activities_view,
         name='indoor-activities'),
    path('outdoor-activities/',
         views.outdoor_activities_view, name='outdoor-activities'),
    path('editactivity/<int:pk>/',
         views.edit_activity, name='edit_activity'),
    path('deleteactivity/<int:pk>/',
